# Diolinux Plus para Franz 
Uma versão não oficial do Forúm Diolinux Plus para Franz.

### Como criar seu próprio Recipe:
* [Leia a documentação](https://github.com/meetfranz/plugins) ou siga o tutorial abaixo:
